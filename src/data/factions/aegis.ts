...
export const AEGIS: Faction = {
  ...
  ships: [
    ...
    { id: "defence-drone", name: "Defence Drone", mass: 0, thrust: 4, silhouette: 4, shields: 1,
      primary: [], auxiliary: [w("Laser Cannon", 1, "D8", 0, 9)], utilityBays: false, cost: 6 },
    { id: "repair-drone", name: "Repair Drone", mass: 1, thrust: 6, silhouette: 4, shields: 1,
      primary: [w("Blasters", 2, "D6", 0, 6)], auxiliary: [], utilityBays: true, auxiliaryUtility: true, cost: 10 },
    ...
    { id: "warden", name: "Warden", mass: 2, thrust: 8, silhouette: 5, shields: 2,
      primary: [], auxiliary: [w("Turbo Blasters", 4, "D6", 0, 6)], utilityBays: true, primaryUtility: true, cost: 20 },
  ...
  hvp: [
    ...
    { id: "threat-assessment-protocols", name: "Threat Assessment Protocols",
      rule: "When making Passive Attacks, ships in this unit may attack each active unit within range once (meaning they can attack multiple times in a single Passive Attacks Step if there are multiple active units within range)." },
