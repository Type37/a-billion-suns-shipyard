...
export const VYKE: Faction = {
  ...
  ships: [
    ...
    { id: "needlefin", name: "Needlefin", mass: 0, thrust: 8, silhouette: 3, shields: 0,
      primary: [], auxiliary: [w("Bioplasm Spitters", 2, "D6", 0, 3)], utilityBays: false, cost: 3 },
  ...
  hvp: [
    ...
    { id: "molt-priest", name: "Molt-Priest",
      rule: "This unit gains access to this command: Ecdysis (1 CMD): Discard 1 damage token from every friendly unit within 15\". Once per Round." },
