...
export const GEN_OMEGA: Faction = {
  ...
  ships: [
    { id: "warcry-fighter-wing", name: "Warcry Fighter Wing", mass: 0, thrust: 8, silhouette: 2, shields: 1,
      primary: [], auxiliary: [w("Light Blasters", 2, "D6", 0, 3)], utilityBays: false, cost: 6 },
    ...
    { id: "halo-class-transport", name: "Halo-class Transport", mass: 1, thrust: 4, silhouette: 6, shields: 3,
      primary: [w("Blasters", 2, "D6", 0, 6)], auxiliary: [], utilityBays: true, auxiliaryUtility: true, cost: 15 },
  ...
  hvp: [
    ...
    { id: "messianic-child", name: "Messianic Child",
      rule: "Friendly units within 12\" of this unit gain the following rule: Once per activation, this unit may suffer 1 damage to use a Command for 0 CMD tokens." },
    { id: "prophet-of-the-end-times", name: "Prophet of the End Times",
      rule: "Units in this fleet gain the following rule: While there is a friendly ship within 6\" that has been given the 'Red Alert' command this round, including this unit itself, this unit may re-roll any misses once each time it attacks." },
