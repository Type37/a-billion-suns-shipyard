...
export const ALLIANCE: Faction = {
  ...
  ships: [
    ...
    { id: "tug", name: "Tug", mass: 1, thrust: 3, silhouette: 4, shields: 1,
      primary: [], auxiliary: [w("Light Blasters", 2, "D6", 0, 3)], utilityBays: true, primaryUtility: true, cost: 5 },
    ...
    { id: "mining-ship", name: "Mining Ship", mass: 2, thrust: 5, silhouette: 6, shields: 3,
      primary: [w("Laser Cannon", 1, "D8", 0, 9)], auxiliary: [], utilityBays: true, auxiliaryUtility: true, cost: 12 },
